class Student:
    ...
    # A == B ➡ __eq__ 호출
    # __eq__를 정의하지 않으면, A == B 는 인스턴스를 비교
    def __eq__(self, obj):
      return self.no == obj.no

    # A != B ➡ __ne__ 호출
    # __ne__를 정의하지 않으면, A != B 는 인스턴스를 비교
    def __ne__(self, obj):
      return self.no != obj.no
...
students = [
  ...
  Student(102, '이재명', '법학과'),
  Student(103, '김문수', '정치학과'),
  Student(104, '이준석', '컴퓨터과학과')
]

for student in students:
    # str(객체) : 해당 객체의 __str__메소드를 호출하는 메소드
    print(str(student))

# == 기호를 이용하여 두 객체를 비교하면,
# 해당 객체의 __eq__메소드가 호출됩니다.
print(students[0] == students[1])
print(students[0] == students[3])
print(students[0] == students[0])

# != 기호를 이용하여 두 객체를 비교하면,
# 해당 객체의 __ne__메소드가 호출됩니다.
print(students[0] != students[1])
print(students[0] != students[3])
print(students[0] != students[0])